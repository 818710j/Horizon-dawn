...
{
    public class StructureShield : SystemBase, IDevice, IFeaturesModification, IStatsModification
    {
        public StructureShield(IShip ship, DeviceStats deviceSpec, int keyBinding)
        ...
        protected override void OnUpdatePhysics(float elapsedTime)
        {
            ...
            {
                _ship.Stats.StructureShield = _power;
                _isEnabled = true;
            }
