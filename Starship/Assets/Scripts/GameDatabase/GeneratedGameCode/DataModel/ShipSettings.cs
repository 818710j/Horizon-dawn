...
namespace GameDatabase.DataModel
{
	public partial class ShipSettings
	{
		...
		private ShipSettings(ShipSettingsSerializable serializable, Database.Loader loader)
		{
            ...
            BaseStructurePoints = UnityEngine.Mathf.Clamp(serializable.BaseStructurePoints, 0f, 1000000f);
            BaseStructureRepairRate = UnityEngine.Mathf.Clamp(serializable.BaseStructureRepairRate, 0f, 1000000f);
            StructureRepairCooldown = UnityEngine.Mathf.Clamp(serializable.StructureRepairCooldown, 0f, 60f);
        ...
        public float BaseStructurePoints { get; private set; }
        public float BaseStructureRepairRate { get; private set; }
        public float StructureRepairCooldown { get; private set; }
