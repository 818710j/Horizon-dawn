...
namespace Gui.StarMap
{
    public class HangarItem : MonoBehaviour
    {
        ...
        private void Initialize()
        {
            ...
            _emptyImage5.gameObject.SetActive(!_icon.gameObject.activeSelf && _sizeClass == SizeClass.subTitan);
            _emptyImage6.gameObject.SetActive(!_icon.gameObject.activeSelf && _sizeClass == SizeClass.Titan);
        }
