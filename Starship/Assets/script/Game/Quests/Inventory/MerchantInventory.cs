			...
			public IEnumerable<IProduct> Items
			{
				get
				{
					if (_items == null)
					{
                        ...
                        _items.AddRange(_lootGenerator.GetRandomComponents(_level - 25, random.Next(7, 14) + extraGoods, Faction.Undefined, _random.Seed + _starId, false, extraGoods > 0 ? Constructor.ComponentQuality.P4 : ComponentQuality.N3)
