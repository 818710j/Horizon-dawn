...
namespace GameModel.Quests
{
    public class InventoryFactory
    {
        ...
        public IInventory CreateBlackMarketInventory(int starId,bool normal=false)
        {
            return new BlackMarketInventory(_starMap.GetStarById(starId), _itemTypeFactory, _productFactory, _playerSkills, _random, _inAppPurchasing, _database, normal);
        }

        public IInventory CreateBlackMarketPlayerInventory(int starId, bool normal=false)
        {
            return new BlackMarketPlayerInventory(_playerResources, _itemTypeFactory, normal);
        }
