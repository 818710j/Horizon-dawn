	...
	public class ComponentViewModel : ComponentListItemBase
	{
		...
		public static IEnumerable<KeyValuePair<string, string>> GetDescription(Constructor.Component.IComponent component, ILocalization localization)
		{
			...
			if (stats.ArmorRepairRate != 0)
				yield return new KeyValuePair<string, string>("$HitPointsRepairRate", FormatFloat(stats.ArmorRepairRate));
			if (stats.ArmorRepairCooldownMultiplier.Value != 1)
				yield return new KeyValuePair<string, string>("$HitPointsRepairCooldown", FormatFloat(stats.ArmorRepairCooldownMultiplier.Value));

			if (stats.StructurePoints != 0)
				yield return new KeyValuePair<string, string>("$StructurePoints", FormatFloat(stats.StructurePoints));
			if (stats.StructureRepairRate != 0)
				yield return new KeyValuePair<string, string>("$StructurePointsRepairRate", FormatFloat(stats.StructureRepairRate));
			if (stats.StructureRepairCooldownMultiplier.Value != 1)
				yield return new KeyValuePair<string, string>("$StructurePointsRepairCooldown", FormatFloat(stats.StructureRepairCooldownMultiplier.Value));
			...
			if (stats.EnergyRechargeCooldownMultiplier.Value != 1)
				yield return new KeyValuePair<string, string>("$RechargeRateCooldown", FormatFloat(stats.EnergyRechargeCooldownMultiplier.Value));
			...
			if (stats.ShieldRechargeCooldownMultiplier.Value != 1) 
				yield return new KeyValuePair<string, string>("$ShieldRechargeRateCooldown", FormatFloat(stats.ShieldRechargeCooldownMultiplier.Value));
			...
			if (stats.StructureResistance != 0)
				yield return new KeyValuePair<string, string>("$StructureDamageResistance", FormatFloat(stats.StructureResistance));
